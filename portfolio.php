...
<head>
    <!--[if lt IE 9]>
        ...
        <title>Howard Laing - portfolio</title>
    ...
    <body>
        ...
        <div id="gallery" class="wrapper flexGRID">
            <h4 class="widget-title">Portfolio</h4>
            <div class="row">
                <div id="lightgallery">
                  <div class="col_4 hovereffect" href="images/neon-template-4.jpg">
                      <img src="images/neon-template-4-small.jpg" />
                  </div>
                  <div class="col_4 hovereffect" href="images/neon-template-4.jpg">
                      <img src="images/neon-template-4-small.jpg" />
                  </div>
                  <div class="col_4 last hovereffect" href="images/neon-template-4.jpg">
                      <img src="images/neon-template-4-small.jpg" />
                  </div>
                  <div class="col_4 hovereffect" href="images/neon-template-4.jpg">
                      <img src="images/neon-template-4-small.jpg" />
